    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(244,144,12,0.08) 0%, transparent 70%)",
          top: "10%",
          left: "5%",
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(255,195,103,0.06) 0%, transparent 70%)",
          bottom: "5%",
          right: "10%",
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(244,144,12,0.05) 0%, transparent 70%)",
          top: "50%",
          left: "50%",
